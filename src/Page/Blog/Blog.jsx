                ...
                <div className="shadow-lg p-3 rounded-4 my-5">
                  ...
                  <p>
                    <ul>
                      ...
                      <li>
                        The components state is managed by React and passed
                        down to the component through props.
                      </li>
                      <li>
                        Any changes to the components state must be done
                    ...
                    <ul>
                      ...
                      <li>
                        The components state is managed internally, usually
                        through the DOM or the components own internal logic.
                      </li>
                      <li>
                        Any changes to the components state are done through
